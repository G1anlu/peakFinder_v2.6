...
import { NumberField } from "@/components/ski/NumberField";
import { TimePickerDropdown } from "@/components/ski/TimePickerDropdown";
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-5xl space-y-6 px-5 py-10">
        ...
        <div className="flex items-start gap-2">
          <Checkbox
            id="itinerary-consent"
            checked={accepted}
            onCheckedChange={(v) => setAccepted(v === true)}
            aria-required="true"
          />
          <Label htmlFor="itinerary-consent" className="text-sm leading-snug font-normal">
        ...
        <Button
          ...
          onClick={submit}
          disabled={!accepted}
          aria-label="Cerca la destinazione più efficiente per il tuo itinerario"
        >
