...
import { directionsUrl, googleSearchUrl, placeUrl } from "@/lib/ski/places";
          ...
          <>
            ...
            <section className="mt-3 rounded-xl border border-border p-4">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <Button asChild size="sm">
                  <a
                    href={googleSearchUrl(itinerary.hotel_name, itinerary.resort_name)}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Cerca su Google <ExternalLink className="ml-1.5 h-3.5 w-3.5" />
                  </a>
                </Button>
                <Button asChild size="sm" variant="secondary">
                  <a
                    href={placeUrl(itinerary.hotel_name, null, itinerary.hotel_address)}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Vedi sulla mappa
                ...
                <Button asChild size="sm" variant="ghost">
                  <a
                    href={directionsUrl(itinerary.hotel_name, null, itinerary.hotel_address)}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
            ...
            <section className="mt-3 rounded-xl border border-border p-4">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <Button asChild size="sm">
                  <a
                    href={googleSearchUrl(itinerary.rental_name, itinerary.resort_name)}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Cerca su Google <ExternalLink className="ml-1.5 h-3.5 w-3.5" />
                ...
                <Button asChild size="sm" variant="secondary">
                  <a
                    href={placeUrl(itinerary.rental_name, null, itinerary.rental_address)}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Vedi sulla mappa
                ...
                <Button asChild size="sm" variant="ghost">
                  <a
                    href={directionsUrl(itinerary.rental_name, null, itinerary.rental_address)}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Indicazioni stradali
